...
//
// Назначение: управление подсветкой области печати принтера с помощью реле
//
// Версия кода (прошивки): 1.0.1
// Версия предыдущего кода (прошивки): 1.0.0
// Обновления:
// - добавлено комментовое описание

#define BLUE 2  // синий светодиод
#define WHITE 1 // белый светодиод
#define LED_O 4 // порт OFF на кнопке (свет включен по умолчанию)
#define LED_R 3 // порт ON на кнопке (свет выключен по умолчанию)
